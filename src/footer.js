    ...
    return (
        <>
            <div className="footer_nav">
              ...
              <a href="https://latestageinteractive.com/blog" target="_blank" rel="noreferrer noopener" className="content">BLOG</a>
              <a href="/accessibility" className="content">ACCESSIBILITY</a>
              <a href="/team" className="content">TEAM</a>
              <a href="https://latestageinteractive.com/press" target="_blank" rel="noreferrer noopener" className="content">PRESSKIT</a>
            </div>
            ...
            <div className="footer_row" style={{alignItems: 'center'}}>
              <div className="footer_row_caveat">
                ...
                <div className="content_bold_link"><a href="https://latestageinteractive.com/privacy" target="_blank" rel="noopener noreferrer">Privacy Policy</a></div>              </div>
